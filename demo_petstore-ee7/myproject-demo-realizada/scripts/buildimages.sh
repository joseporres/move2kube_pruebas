...
echo 'building image petstoreee7-buildstage'
cd source
${CONTAINER_RUNTIME} build -f Dockerfile.buildstage -t petstoreee7-buildstage .
cd -

echo 'building image petstoreee7'
cd source
${CONTAINER_RUNTIME} build -f Dockerfile -t petstoreee7 .
cd -
