...
echo 'building and pushing image petstoreee7-buildstage'
cd source
docker buildx build --platform ${PLATFORMS} -f Dockerfile.buildstage  --push --tag ${REGISTRY_URL}/${REGISTRY_NAMESPACE}/petstoreee7-buildstage .
cd -

echo 'building and pushing image petstoreee7'
cd source
docker buildx build --platform ${PLATFORMS} -f Dockerfile  --push --tag ${REGISTRY_URL}/${REGISTRY_NAMESPACE}/petstoreee7 .
cd -
